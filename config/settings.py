...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-uer*5is!k-n6v$n9#&3dy7br93lpr7rmkfcu%2&f6)2)qj#__0')
...
CELERY_BROKER_URL = f"pyamqp://{os.getenv('RABBITMQ_HOST', 'localhost')}:{os.getenv('RABBITMQ_PORT', '5672')}//"
